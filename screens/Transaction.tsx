...
export default function TransactionScreen({ route, navigation }: Props): JSX.Element {
  ...
  const [ category, updateCategory ] = React.useState<string>("Thuộc loại");
  ...
  function handleSubmit(): void {
    ...
    const newTitle: string = title ? title : "Không có tiêu đề";
      ...
      >
        ...
        >
          <View style={[
            ...
            <Text style={[ styles.text, { color: "#171717" } ]}>Lưu</Text>
          </View>
        </TouchableOpacity>
      </View>
    </>
